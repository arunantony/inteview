...
import AInfiniteScrollInfo from '../markdown/Advanced_InfinitScroll.md';

const AInfiniteScroll = () => {
  return (
    <>
      <Instructions renderData={AInfiniteScrollInfo} />
      <div>{/* Your code goes here */}</div>
    </>
  );
};

export default AInfiniteScroll;
